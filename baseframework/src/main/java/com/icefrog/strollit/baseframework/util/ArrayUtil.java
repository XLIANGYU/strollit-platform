 ...
 * 有关数组处理的工具类。
 *
 * <p> 这个类中的每个方法都可以“安全”地处理<code>null</code>，而不会抛出<code>NullPointerException</code>。 </p>
 *
 */
public class ArrayUtil {
     ...
     * 将数组转换成易于阅读的字符串表示。
     *
     * <p> 如果数组是<code>null</code>则返回<code>[]</code>，支持多维数组。 如果数组元素为<code>null</code>，则显示<code>&lt;null&gt;</code>。
     *
     * <pre>
     ...
     * 将数组转换成易于阅读的字符串表示。
     *
     * <p> 如果数组是<code>null</code>则返回指定字符串，支持多维数组。 如果数组元素为<code>null</code>，则显示<code>&lt;null&gt;</code>。
     *
     * <pre>
     ...
     * 将数组转换成易于阅读的字符串表示。
     *
     * <p> 如果数组是<code>null</code>则返回指定字符串，支持多维数组。 如果数组元素为<code>null</code>，则显示指定字符串。
     *
     * <pre>
    ...
    private static void toString(StringBuffer buffer, Object array, String nullArrayStr,
        ...
        if (!array.getClass().isArray()) {
            buffer.append(object2String(array, nullElementStr));
            return;
        }
