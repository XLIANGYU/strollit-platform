...
public class JedisClusterService {
     ...
     * without limits. This is very useful when using Redis to store logs for example. It is
     ...
     * List, Set, or Sorted Set value at key and store the result at dstkey. By default sorting is
